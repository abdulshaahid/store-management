...
const useSales = () => ({
  data: [
    { id: 1, date: new Date(), productName: "Widget A", quantity: 5, amount: 150 },
    { id: 2, date: new Date(), productName: "Widget B", quantity: 3, amount: 90 },
    { id: 3, date: new Date(), productName: "Widget A", quantity: 2, amount: 60 },
    { id: 4, date: new Date(Date.now() - 86400000), productName: "Widget C", quantity: 10, amount: 300 },
    { id: 5, date: new Date(Date.now() - 86400000 * 2), productName: "Widget A", quantity: 4, amount: 120 },
    { id: 6, date: new Date(), productName: "Widget D", quantity: 7, amount: 210 },
    { id: 7, date: new Date(), productName: "Widget E", quantity: 2, amount: 80 },
    { id: 8, date: new Date(), productName: "Widget F", quantity: 1, amount: 40 },
  ]
})
